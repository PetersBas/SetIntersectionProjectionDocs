...
scholdoc --css='https://www.slim.eos.ubc.ca/Publications/Resources/ScholMD/standalone/slimweb-scholmd-standalone-v0.1-latest.min.css' --mathjax='https://www.slim.eos.ubc.ca/MathJax/MathJax.js?config=TeX-AMS_HTML-full' --to=html --default-image-extension=png --citeproc "README_image_proc_constraint_learning.md" "/Tools/ScholarlyMarkdown-SLIM/configs/slim_js.yaml" "/Tools/ScholarlyMarkdown-SLIM/configs/default_csl.yaml" -o "README_image_proc_constraint_learning.html" 2>&1
